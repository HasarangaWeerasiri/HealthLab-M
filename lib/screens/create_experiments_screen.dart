...
class CreateExperimentsScreen extends StatefulWidget {
  ...
  @override
  State<CreateExperimentsScreen> createState() =>
      _CreateExperimentsScreenState();
}
                  ...
                  if (_drafts.isNotEmpty) ...[
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, i) {
                        final d = _drafts[i];
                        return _DraftTile(
                          title: (d['title'] as String?)?.isNotEmpty == true
                              ? d['title']
                              : 'Untitled experiment',
                          ...
                          onDelete: () async {
                            await DraftExperimentService().removeDraft(
                              d['id'] as String,
                            );
                            _loadDrafts();
                          },
              ...
              Align(
                ...
                child: OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    side: BorderSide(color: themeProvider.buttonColor),
      ...
      builder: (context, themeProvider, _) {
        return Container(
          ...
          child: ListTile(
            ...
            subtitle: Text(
              subtitle,
              style: const TextStyle(color: Color(0xFF1E4029)),
            ),
            trailing: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                IconButton(
                  icon: Icon(Icons.edit, color: themeProvider.buttonColor),
                  onPressed: onOpen,
                ),
                IconButton(
...
List<_Template> _buildTemplates() {
  return [
    ...
    _Template(
      ...
      previewLines: const [
        'Caffeine amount: Number (mg)',
        'Pomodoro done?: Yes/No',
      ],
    ),
  ];
}
